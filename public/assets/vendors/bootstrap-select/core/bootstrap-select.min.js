    ...
    !(function ($) {
        ...
        $.fn.triggerNative = function (e) {
            var t,
                i = this[0];
            i.dispatchEvent &&
                (V ? (t = new Event(e, { bubbles: !0 })) : (t = document.createEvent('Event')).initEvent(e, !0, !1),
                i.dispatchEvent(t));
        };
        var j = {
                '\xc0': 'A',
            ...
            (H.prototype = {
                ...
                buildList: function (e, t) {
                    ...
                    (!i.options.showTick && !i.multiple) ||
                        ...
                        ((D.checkMark.className = this.options.iconBase + ' ' + i.options.tickIcon + ' check-mark'),
                ...
                liHeight: function (e) {
                    if (e || (!1 !== this.options.size && !Object.keys(this.sizeInfo).length)) {
                        ...
                        ((r = t.offsetHeight),
                            ...
                            (o = {
                                vert:
                                    v(h.paddingTop) + v(h.paddingBottom) + v(h.borderTopWidth) + v(h.borderBottomWidth),
                                horiz:
                                    v(h.paddingLeft) + v(h.paddingRight) + v(h.borderLeftWidth) + v(h.borderRightWidth),
                            }),
                            (h = {
                ...
                clickListener: function () {
                    ...
                    (t.data('spaceSelect', !1),
                        ...
                        this.$menu.on(
                            'click',
                            'li.' + T.DISABLED + ' a, .' + T.POPOVERHEADER + ', .' + T.POPOVERHEADER + ' :not(.close)',
                            function (e) {
                ...
                changeAll: function (e) {
                    if (this.multiple) {
                        ...
                        (t.classList.remove('bs-select-hidden'),
                            i !== s &&
                                (this.setOptionStatus(), (E = [null, null, n]), this.$element.triggerNative('change')));
                    }
                },
                selectAll: function () {
                        ...
                        if (
                                    ...
                                    e.which === C
                                        ? (-1 !== d && d--,
                                          ...
                                          r.selectpicker.view.canHighlight[d + p] ||
                                              (-1 ===
                                                  (d =
                                                      r.selectpicker.view.canHighlight.slice(0, d + p).lastIndexOf(!0) -
                                                      p) &&
                                                  (d = a.length - 1)))
                                        : (e.which !== O && !l) ||
                                          ...
                                          r.selectpicker.view.canHighlight[d + p] ||
                                              (d =
                                                  d +
                                                  1 +
                                                  r.selectpicker.view.canHighlight.slice(d + p + 1).indexOf(!0))),
                                    e.preventDefault());
                                var u = p + d;
                                (e.which === C
                                    ? 0 === p && d === a.length - 1
                            ...
                            t &&
                                ...
                                (r.options.liveSearch && e.which === w) ||
                                    ...
                                    o.trigger('focus'),
                                    r.options.liveSearch || (e.preventDefault(), $(document).data('spaceSelect', !0))));
                        }
                },
                mobile: function () {
