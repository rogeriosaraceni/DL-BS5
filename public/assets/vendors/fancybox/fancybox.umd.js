    ...
    /*! License details at fancyapps.com/license */ (function (e, t) {
        ...
        let t,
            ...
            d = (e = !0, t = '--f-scrollbar-compensate', n = '--f-body-margin', o = 'hide-scrollbar') => {
                ...
                } else (a.classList.remove(o), a.style.setProperty(n, ''), i.documentElement.style.setProperty(t, ''));
            },
            f = (e, ...t) => {
                let n = t.length;
                for (let o = 0; o < n; o++)
        ...
        let p = function (e = 0, t = 0, n = 0) {
            ...
            m = function (e = 0, t = 0, n = 0, o = 0, i = 0, a = !1) {
                let l = ((e - t) / (n - t)) * (i - o) + o;
                return a ? (o < i ? p(o, l, i) : p(i, l, o)) : l;
            },
            h = (e, t = '') => {
                e &&
                    e.classList &&
        ...
        function _() {
            ...
            let D = {
                ...
                spring: function (e = {}) {
                    ...
                    return ((l = n), (r = o), (s = i), (c = a), (f = p), (d = m), (u = h), (g = v), (M = {}), D);
                },
                isRunning: function () {
                    return e === w.Running;
                },
                ...
                start: function (t) {
                    return (
                        (e = w.Initializing),
                        y((m = { ...v }), x) || (I.add(this), $ || ($ = window.requestAnimationFrame(E)), O(t)),
                        D
                    );
                },
                pause: function () {
                            ...
                            M[n] ||
                                ('object' == typeof l && 'number' == typeof l[n]
                                    ...
                                    : 'number' == typeof l
                                      ...
                                      : (M[n] = 0));
                            let a = M[n],
                                m = (a = p(-1 * Math.abs(u), a, Math.abs(u))) * r * c,
                                h = Math.abs(o - i) * s;
                            ((a += (((i > o ? -1 : 1) * h - m) / r) * e), (i += a * e));
                            let y = v[n] > o ? i < o : i > o,
                                b = Math.abs(a) < d && Math.abs(o - i) <= f;
                            (g && y && (b = !0), b ? ((i = o), (a = 0)) : t++, (v[n] = i), (M[n] = a));
                        }
                        E = !t;
                    }
                    let L = { ...x };
                    return (C('step', v, m, x, h), E && e === w.Running && y(x, L) && ((e = w.Completed), F()), D);
                },
            ...
            G = (e, t) => {
                ...
                function R() {
                    if (((y = 0), (b = 0), w.length > 3)) {
                        ...
                        if (e && t) {
                            ...
                            i > 0 &&
                                ((y = Math.abs(n) > 3 ? n / (i / 30) : 0), (b = Math.abs(o) > 3 ? o / (i / 30) : 0));
                        }
                    }
                }
                function P(e) {
                    ...
                    if (
                        t.matches(o) ||
                        t.closest(o) ||
                        ('undefined' != typeof MouseEvent && e instanceof MouseEvent && (!e.buttons || 0 !== e.button))
                    )
                        return;
                    ...
                    ((d = m > 0 && m <= 250),
                        ...
                        (i = e),
                        e instanceof MouseEvent &&
                            (window.addEventListener('mousemove', C), window.addEventListener('mouseup', O)),
                ...
                function C(e) {
                    ...
                    if (
                        ...
                        ((h = t.x - e.x),
                            (v = t.y - e.y),
                            (c = Math.abs(h) > a.panThreshold || Math.abs(v) > a.panThreshold) &&
                                ((Z = !1),
                                clearTimeout(M),
                                (M = 0),
        ...
        let Y = {
            ...
            el = (e, n = {}, o = {}) => {
                ...
                function C() {
                    if ((e && (e.querySelector('.f-spinner')?.remove(), e.classList.remove('is-loading')), !e || !i))
                        return;
                    if (a instanceof HTMLImageElement && !(a.complete && a.naturalWidth)) {
                        ((v = et.Error), i?.classList.add('has-error'), S('error'));
                        return;
                    }
                    S('loaded');
                    let { width: t, height: n } = A();
                    (a && (a.setAttribute('width', t + ''), a.setAttribute('height', n + '')),
                        i &&
                        ...
                        (f = _()
                            ...
                            .on('step', (t) => {
                                ...
                                if (
                                    ((E = { ...ee, ...t }),
                                    z() || !M('bounds') || d?.isPointerDown() || w.scale > E.scale || w.scale < F())
                                )
                                    return void Y();
                                let n = q(w.scale),
                                    o = !1,
                                ...
                                (((i && s) || (o && r)) && ((w.x = p(n.x[0], w.x, n.x[1])), (g = !0)),
                                    ((a && c) || (l && u)) && ((w.y = p(n.y[0], w.y, n.y[1])), (g = !0)),
                                    g &&
                                        f
                                            .spring({
                                                tension: 94,
                                ...
                                (d = G(c, e)
                                    ...
                                    .on('move', (e) => {
                                        !z() &&
                                            ...
                                            (e.srcEvent.preventDefault(), e.srcEvent.stopPropagation());
                                    })
                                    .on('pan', (e) => {
                                        if (z()) return;
                                        let t = e.srcEvent;
                                    ...
                                    .on('end', (e) => {
                                        z() ||
                                            (e.currentTouch.length
                                                ? (e.srcEvent.stopPropagation(), U(e.srcEvent), f?.end())
                                                : (W(), B(), S('touchEnd')));
                                    })
                                    .init());
                        })(),
                ...
                function q(t) {
                    ...
                    if (z() && t > 1) {
                        ...
                        e > 1 && (r * t > a + 0.01 && (c *= e), s * t > l + 0.01 && (u *= e));
                    }
                    return (
                        (r *= c),
                        (s *= u),
                ...
                function W() {
                    ...
                    for (let t of e?.querySelectorAll('[data-panzoom-action]') || []) {
                        ...
                        n
                            ? (t.setAttribute('aria-disabled', ''), t.setAttribute('tabindex', '-1'))
                            : (t.removeAttribute('aria-disabled'), t.removeAttribute('tabindex'));
                    }
                }
                function Z(t, n) {
                    if (!e || !a || !f || (t === J.Swipe && Math.abs(f.getCurrentVelocities().scale) > 0.01)) return;
                    let o = { ...w },
                    ...
                    switch (t) {
                        ...
                        case J.MoveDown:
                            if (d?.isPointerDown()) {
                                ...
                                (w.x <= i.x[0] &&
                                    c <= 0 &&
                                    (e = 0.2 * Math.max(0.01, 1 - Math.abs((1 / r.width) * Math.abs(w.x - i.x[0])))),
                                    w.x >= i.x[1] &&
                                        c >= 0 &&
                                        (e =
                                            0.2 * Math.max(0.01, 1 - Math.abs((1 / r.width) * Math.abs(w.x - i.x[1])))),
                                    w.y <= i.y[0] &&
                                        u <= 0 &&
                                        (t =
                                            0.2 *
                                            Math.max(0.01, 1 - Math.abs((1 / r.height) * Math.abs(w.y - i.y[0])))),
                                    w.y >= i.y[1] &&
                                        u >= 0 &&
                                        (t =
                                            0.2 *
                                            Math.max(0.01, 1 - Math.abs((1 / r.height) * Math.abs(w.y - i.y[1])))),
                                    (w.x += m * e),
                                    (w.y += h * t));
                        ...
                        case J.Zoom:
                            let b = j();
                            w.scale >= b - 0.05 ? (w.scale = F()) : (w.scale = Math.min(b, w.scale * (n.scale || 2)));
                            break;
                        case J.RotateCW:
                            w.angle += 90;
                            break;
                    ...
                    if ((s && (w.scale = p($() * (s ? 0.8 : 1), w.scale, N() * (s ? 1.6 : 1))), z())) {
                        ...
                        ((w.x = a - c * w.scale),
                            ...
                            !s &&
                                M('bounds') &&
                                ((i = q(w.scale)), (w.x = p(i.x[0], w.x, i.x[1])), (w.y = p(i.y[0], w.y, i.y[1]))));
                    }
                    if (t === J.Swipe) {
                        let e = 500 * w.scale;
                        f.spring({
                ...
                function Y() {
                    ...
                    if (i && d) {
                        let { x: e, y: t, width: n, height: o, scale: i, flipX: a, flipY: r } = d,
                        ...
                        return (
                            ...
                            (function () {
                                ...
                                if (
                                    ...
                                    a instanceof HTMLImageElement || a instanceof HTMLPictureElement)
                                ) {
                                    ...
                                    ((g = new ResizeObserver(() => {
                                        t ||
                                            (t = requestAnimationFrame(() => {
                                                (e && e.parentElement && v === et.Ready && (W(), B(), S('refresh')),
                                                    (t = null));
                                            }));
                                    })).observe(e),
                                        x.push(() => {
        ...
        let er = (e, t) => {
            ...
            eh = (e, t = {}, o = {}) => {
                ...
                function B(e, ...t) {
                    let n = E[e];
                    return n && n instanceof Function ? n(eO, ...t) : n;
                }
                function W(e, t = []) {
                    let n = B('l10n') || {};
                    e = String(e).replace(/\{\{(\w+)\}\}/g, (e, t) => n[t] || e);
                ...
                function Y(e, ...t) {
                    let n = Z.get(e) || [];
                    for (let o of (E.on && n.push(E.on[e]), n)) o && o instanceof Function && o(eO, ...t);
                    '*' !== e && Y('*', e, ...t);
                }
                function X() {
                    let e = f({}, ep, b);
                        ...
                        (eC(),
                            !1 !== (E = e).enabled &&
                                ...
                                (function () {
                                    ...
                                    let t = B('style');
                                    if (t && a(t)) for (let [e, n] of Object.entries(t)) x.style.setProperty(e, n);
                                    ((M = x.querySelector(`.${e.viewport}`)) ||
                                        ...
                                        (L = 'visible' === window.getComputedStyle(M).getPropertyValue('overflow')),
                                        (x.carousel = eO),
                                        Y('initLayout'));
                                })(),
                                (function () {
                                    ...
                                    M &&
                                        ...
                                        (i = G(M, e)
                                            .on('start', (e) => {
                                                if (!c) return;
                                                let { srcEvent: t } = e;
                                                (R && ed(t), c.pause(), (c.getCurrentVelocities().pos = 0));
                                                let n = j[A]?.slides[0];
                                                (n &&
                                                    H.has(n.index) &&
                                                    n.el &&
                                            ...
                                            .on('end', (e) => {
                                                ...
                                                if (
                                                    ...
                                                    let e = 0;
                                                    (Math.abs(r) > 0 &&
                                                        ((e = 2 * Math.abs(r)), (e = Math.min(0.3 * eo(), e))),
                                                        (s = p(k + -1 * e, s, I + e)),
                                                        c
                                                            .spring({
                                                                clamp: !0,
                                                ...
                                                if (
                                                    ...
                                                    (!(e.offsetX || e.offsetY) || ('y' === t && !R) || ('x' === t && R))
                                                )
                                                    return void eR(A, {
                                                        transition: 'tween',
                                                    });
                                            ...
                                            e ||
                                                (e = requestAnimationFrame(() => {
                                                    ((function (e) {
                                                        ...
                                                        if (y === ef.Init) {
                                                            ((N = t), (q = n), (y = ef.Ready), eP(), Q(), Y('ready'));
                                                            return;
                                                        }
                ...
                function K(e = '*') {
                    let t = [];
                    for (let n of F)
                        ('*' === e || (n.class && n.class.includes(e)) || (n.el && n.el?.classList.contains(e))) &&
                            t.push(n);
                    ((g = void 0), ($ = e), (D = [...t]));
                }
                function J() {
                    if (!c) return;
                    let e = et(c?.isRunning() ? c.getEndValues().pos : C);
                    e !== A && ((g = A), (A = e), eT(), Q(), ee(), Y('change', A, g));
                }
                function Q() {
                    if (!x) return;
                ...
                function et(e) {
                    ...
                    return parseInt(
                        (o.size > 0 ? [...o.entries()].reduce((e, t) => (t[1] < e[1] ? t : e)) : [A, 0])[0],
                    );
                }
                function en() {
                ...
                function ea(e) {
                    ...
                    for (let s of D) {
                        let c = (t = 0) => {
                            !(i.indexOf(s) > -1) &&
                                ((s.pos = r - e + t || 0),
                                s.offset + t > e - s.dim - a + 0.51 && s.offset + t < e + o + l - 0.51 && i.push(s));
                        };
                ...
                function el(e, t) {
                    ...
                    for (let t of Array.isArray(e) ? e : [e]) {
                        let e = eu({ ...t, isVirtual: !0 });
                        n.push(e);
                    }
                    for (let e of (F.splice(void 0 === t ? F.length : t, 0, ...n), ey(), n))
                        !(function (e) {
                            if (!e) return;
                            let t = e.el;
                ...
                function eg(e) {
                    ...
                    if (t) {
                        if ((t.setAttribute('index', e.index + ''), t.parentElement !== M)) {
                            let n;
                            for (let o of (h(t, E.classes.slide), h(t, e.class), eT(e), F))
                                if (o.index > e.index) {
                                    n = o.el;
                                    break;
                                }
                ...
                function ev(e) {
                    let t = e?.el;
                    t && (t.remove(), eE(t), Y('detachSlideEl', e));
                }
                function ey() {
                    for (let e = 0; e < F.length; e++) {
                        let t = F[e],
                            n = t.el;
                        (n && (t.index !== e && eE(n), n.setAttribute('index', `${e}`)), (t.index = e));
                    }
                }
                function eb() {
                    if (!x || !M) return;
                    ...
                    for (let e of D) {
                        ...
                        if (!e.isVirtual && t && r(t)) {
                            let e = !1;
                            ((t.parentElement && t.parentElement === M) || (M.appendChild(t), (e = !0)),
                    ...
                    if (
                        ...
                        (S = B('infinite') && j.length > 1 && ei() - (eo() + (D[0]?.dim || 0)) > -0.5),
                        (k = j[0]?.pos || 0),
                        ...
                        (void 0 !== e && (A = eO.getPageIndex(e) || 0),
                            (A = p(0, A, j.length - 1)),
                            (z = C = j[A]?.pos || 0));
                    } else {
                ...
                function eE(e) {
                    ...
                    (e.removeEventListener('animationend', ex), es(e, o.join(' ')), H.delete(t));
                }
                function ew() {
                    if (!M) return;
                    let e = H.size;
                    for (let e of D) eE(e.el);
                    (H.clear(), e && eP());
                }
                function ex(e) {
                    'f-' === e.animationName.substring(0, 2) &&
                        ...
                        !H.size &&
                            (es(x, 'in-transition'),
                            !O && 0.5 > Math.abs(eO.getPosition(!0) - z) && ((O = !0), Y('settle'))),
                        eP());
                }
                function eM(e) {
                    ...
                    if (n) {
                        (ed(e), eO.goTo(parseFloat(n.dataset.carouselGoTo || '') || 0));
                        return;
                    }
                ...
                function eT(e) {
                    ...
                    if (o && o instanceof HTMLElement) {
                        if (e.index !== A) return;
                        if ((l(n) && (o.innerHTML = W(n + '')), n instanceof HTMLElement)) {
                    ...
                    (!i && n instanceof HTMLElement && n.classList.contains('f-caption') && (i = n),
                        !i &&
                            ...
                            l(n)
                                ? (i.innerHTML = W(n + ''))
                                : n instanceof HTMLElement && (n.parentElement && (n = n.cloneNode(!0)), i.append(n))));
                    let a = `f-caption-${em}_${e.index}`;
                    (i.setAttribute('id', a),
                ...
                function eR(e, t) {
                    ...
                    if (
                        !i ||
                        (function (e, t) {
                            if (!x || !c || !t || !l(t) || 'tween' === t || j[A]?.slides.length > 1) return !1;
                            let n = j.length,
                                o = e > A ? 1 : -1;
                            ...
                            if (
                                ...
                                a === s ||
                                C === u ||
                                Math.abs(eo() - (r?.dim || 0)) > 1
                            )
                                return !1;
                            ((O = !1), c.pause(), ew(), h(x, 'in-transition'), (C = z = u));
                            let d = eg(i),
                                f = eg(r);
                            return (
                                J(),
                                d &&
                                    (H.add(a),
                                    (d.style.transform = ''),
                                    d.addEventListener('animationend', ex),
                                    es(d, E.classes.isSelected),
                                    h(d, `f-${t}Out to-${o > 0 ? 'next' : 'prev'}`)),
                                f &&
                                    (H.add(s),
                                    (f.style.transform = ''),
                                    f.addEventListener('animationend', ex),
                    ...
                    if (1 > Math.abs(z - r)) {
                        ((C = z),
                            A !== e && (eT(), Q(), ee(), (g = A), Y('change', (A = e), g)),
                            eP(),
                            O || ((O = !0), Y('settle')));
                        return;
                    }
                    ...
                    if (!1 !== n && a(o)) return void c.spring(o).from({ pos: C }).to({ pos: z }).start();
                    ((C = z), J(), eP(), O || ((O = !0), Y('settle')));
                }
                function eP() {
                    let e;
                    if (!x || !M) return;
                    ...
                    for (let i of D) {
                        ...
                        if (!a) continue;
                        o.push(i);
                        let l = t?.slides?.indexOf(i) > -1;
                        if ((l && n.add(a), !H.has(i.index))) {
                            ...
                            r instanceof Function
                                ...
                                : (a.style.transform = t || n ? `translate3d(${o}%, ${l}%,0)` : '');
                        }
                        if (B('adaptiveHeight') && l) {
                            let t = (a.firstElementChild || a).getBoundingClientRect().height;
                            e = void 0 == e ? t : Math.max(e, t);
                        }
                    }
                    ([...er(M, `.${E.classes.slide}`)].forEach((e) => {
                        let t = F[parseInt(e.getAttribute('index') || '-1')];
                        (t || e.remove(),
                            ec(e, E.classes.isSelected, n.has(e)),
                            t.isVirtual && !H.has(t.index) && 0 > V.indexOf(t) && ev(t));
                    }),
                        M && e && (M.style.height = `${e}px`),
                        Y('render', o));
                }
                function eC() {
                    for (let e of (x?.removeEventListener('click', eM),
                    ew(),
                ...
                let eO = {
                    add: function (e, t) {
                        let n = C,
                            o = z;
                        for (let n of el(e, t)) Y('addSlide', n);
                        return (
                            K($),
                            eb(),
                            c &&
                    ...
                    emit: Y,
                    filter: function (e = '*') {
                        return (K(e), eb(), eP(), Y('filter', e), eO);
                    },
                    getContainer: function () {
                        return x;
                    },
                    ...
                    getPageVisibility: function (e) {
                        ...
                        let t = j[e];
                        if (!t) return e > A ? -1 : 1;
                        let n = eO.getPosition(),
                            o = eo(),
                            i = t.pos;
                        if (S) {
                            let e = eO.getPosition(),
                                t = ei(),
                    ...
                    remove: function (e) {
                        void 0 === e && (e = F.length - 1);
                        let t = F[e];
                        return (
                            t &&
                                (Y('removeSlide', t),
                                t.el && (eE(t.el), t.el.remove(), (t.el = void 0)),
                                F.splice(e, 1),
                                K($),
                                eb(),
                                eP()),
                    ...
                    showLoading: function (e) {
                        ...
                        return (
                            o && (h(o, 'f-spinner'), h(t, 'is-loading'), t.insertAdjacentElement('beforeend', o)),
                            eO
                        );
                    },
                    version: '6.0.14',
    ...
    data-lazy-src="{{src}}" alt="{{alt}}" />`,
                ...
                function r(n, o) {
                    ...
                    if (a && l(a) && !o.html && (!o.type || 'image' === o.type)) {
                        ...
                        ((e = ev(e, '{{src}}', a + '')),
                            (e = ev(e, '{{srcset}}', r + '')),
                            (e = ev(e, '{{sizes}}', s + '')),
                            (e = ev(e, '{{alt}}', `${o.alt || o.caption || `Image #${o.index}`}`)),
            ...
            eS = () => {
                ...
                function n() {
                    ...
                    let n = t().preload,
                        ...
                        i = e.getPosition(),
                        a = e.getViewportDim();
                    for (let l of (o.push(...e.getVisibleSlides(i + a * n), ...e.getVisibleSlides(i - a * n)), o || []))
                        !(function (n) {
                            let o = n.el;
                            if (!o) return;
                                ...
                                u &&
                                    (s && u
                                        ? (t().showLoading && e?.showLoading(n),
                                          ...
                                          a && (l.sizes = a))
                                        : c &&
                                          (document.body.contains(l) || (document.createElement('img').src = r),
                ...
                function l() {
                    e && !1 !== e.getOptions().Arrows && e.getPages().length > 1
                        ? (!(function () {
                              ...
                              let i = e.getViewport();
                              i &&
                                  (!t && (t = o('prev')) && i.insertAdjacentElement('beforebegin', t),
            ...
            ez = () => {
                ...
                function o() {
                    ...
                    for (let t of e.getSlides())
                        (t.panzoomRef && (r = !0), (t.downloadSrc || ('image' === t.type && t.src)) && (c = !0));
            ...
            eI = () => {
                ...
                function u() {
                    !(t || i || s()) &&
                        ...
                        ((function () {
                            ...
                            ((l = document.createElement('div')).classList.add('f-progressbar'), t.prepend(l));
                            let n = r('timeout') || 1e3;
                ...
                function d() {
                    ...
                    (t &&
                        ...
                        (t.addEventListener('mouseenter', E, !1), t.addEventListener('mouseleave', w, !1)),
                        e.on('change', v),
                        e.on('settle', y),
                        e.on('contentReady', m),
            ...
            eF = () => {
                ...
                function m() {
                    if (!o || !e || !n || t) return;
                    let a = [];
                    for (let t of e.getSlides()) a.push(g(t));
                    a.length &&
                        ((t = o(
                            n,
                            f(
                ...
                function h() {
                    c() && (s('showOnStart') && (d(), m()), e?.getGestures()?.on('start', v), e?.on('addSlide', E));
                }
                function v() {
                ...
                function x() {
                    ...
                    for (let t of n) {
                        ...
                        ((a = Math.max(-1, Math.min(1, a))) > -1 && a < 1 && (o += 0.5 * i * (1 - Math.abs(a))),
                ...
                return {
                    init: function (t, n) {
                        ((o = n), (e = t).on('ready', h), e.on('render', y), e.on('change', b));
                    },
                    destroy: function () {
                        (e?.off('ready', h),
                            e?.off('render', y),
                ...
                function f() {
                    ...
                    (e && void 0 !== e.autoplay ? e.autoplay : n().autoplay) &&
                        (!(function () {
                            ...
                            let n = e?.htmlEl;
                            n instanceof HTMLIFrameElement &&
                                n.contentWindow?.postMessage('{"event":"command","func":"stopVideo","args":""}', '*');
                        })(),
                        (function () {
                            let e = o(),
                                t = e?.type;
                    ...
                    if (e && t && ('html5video' === e.type || 'youtube' === e.type || 'vimeo' === e.type)) {
                        ...
                        if (e.aspectRatio) {
                            ...
                            let a = t.getBoundingClientRect(),
                                l = (o && i ? o / i : o) < (a.width || 1) / (a.height || 1);
      ...
      <div class="fancybox__carousel"></div>
            ...
            e9 = {
                ...
                bind: function (e, t, n) {
                    ...
                    if (
                        (l(e)
                            ? ((o = document.body), (i = e), 'object' == typeof t && (a = t || {}))
                            : e instanceof Element && ((o = e), l(t) && (i = t), 'object' == typeof n && (a = n || {})),
                ...
                fromEvent: function (e) {
                    ...
                    if (!(t && n && o)) return;
                    e.preventDefault();
                    let l = f({}, e3, { triggerEvent: e, triggerEl: i, delegateEl: a }, o),
                        r = l.groupAll,
                        s = l.groupAttr,
                    ...
                    if ((i && !r && (u = c ? u.filter((e) => e.getAttribute(`${s}`) === c) : [i]), !u.length)) return;
                ...
                fromSelector: function (e, t, n) {
                    ...
                    if (r && (a = f({}, r.get(i) || {}, a))) return e9.fromNodes(Array.from(o.querySelectorAll(i)), a);
                },
                ...
                show: function (e = [], t = {}) {
                    return (() => {
                        ...
                        function x(e, ...t) {
                            let n = p[e];
                            return n && 'function' == typeof n ? n(en, ...t) : n;
                        }
                        function M(e, t = []) {
                            let n = x('l10n') || {};
                            e = String(e).replace(/\{\{(\w+)\}\}/g, (e, t) => n[t] || e);
                        ...
                        function S(e, ...t) {
                            ...
                            for (let e of n) e && 'function' == typeof e && e(en, ...t);
                            '*' !== e && S('*', e, ...t);
                        }
                        function T() {
                            es(i, 'is-revealing');
                        ...
                        function R(e) {
                            ...
                            let t = e.composedPath()[0];
                            t.closest('.fancybox__carousel') && t.classList.contains('fancybox__slide') && P(e);
                        }
                        function P(e) {
                            if (e.composedPath()[0].closest('[data-fancybox-close]')) return void J(e);
                            (S('backdropClick', e), !e.defaultPrevented && x('backdropClick') && J(e));
                        }
                        function C(e) {
                            if (!N() || g !== e4.Ready || (U(), e.defaultPrevented)) return;
                            let t = e.composedPath()[0],
                        ...
                        function k(t) {
                            ...
                            if (!n || !o || i) return;
                            let a = x('closeButton');
                            if (('auto' === a && (a = e?.getPlugins().Toolbar?.isEnabled() !== !0), a)) {
                                let e = s(M(e1));
                                e &&
                                ...
                                (function () {
                                    ...
                                    t.on('start', function () {
                                        ...
                                        .on('end', function (e) {
                                            if (
                                                (a.pause(),
                                                'y' === e.axis && Math.abs(e.velocityY) > 5 && Math.abs(o) > 0)
                                            )
                                                return void J(
                                                    e.srcEvent,
                        ...
                        function D(t) {
                            if (
                                ...
                                return;
                            w = !1;
                            let n = x('zoomEffect') ? W(t) : void 0,
                                o = t.panzoomRef,
                                i = o?.getTween();
                            if (o && i && n) {
                                let e = o.getScale('base') || 1,
                                    { x: t, y: a } = o.getMousemovePos(e) || {
                                        x: 0,
                                        y: 0,
                                    };
                                i.spring({
                            ...
                            if (i instanceof HTMLImageElement) {
                                ...
                                if ('contain' === e || 'scale-down' === e) {
                                    let { width: t, height: n } = ((e, t, n, o, i = 'contain') => {
                                        ...
                                        return { width: e, height: t };
                                    })(i.naturalWidth, i.naturalHeight, l, r, e);
                                    ((s += (l - t) * 0.5), (c += (r - n) * 0.5), (l = t), (r = n));
                                }
                            }
                            if (Math.abs(n / o - l / r) > 0.1) return;
                            let u = s + 0.5 * l - (t.left + 0.5 * n);
                            return {
                                x: u,
                                y: c + 0.5 * r - (t.top + 0.5 * o),
                                scale: l / n,
                            };
                        }
                        function Z() {
                            (n && clearTimeout(n), (n = void 0), document.removeEventListener('mousemove', V));
                        }
                        function Y() {
                            if (E || n) return;
                            let e = x('idle');
                        ...
                        function X() {
                            i && (Z(), h(i, 'is-idle'), document.addEventListener('mousemove', V), (E = !0));
                        }
                        function U() {
                            E && (K(), Y());
                        }
                        ...
                        function Q(t, n) {
                            ...
                            (x('fadeEffect') && (i?.classList.remove('is-ready'), i?.classList.add('is-hiding')),
                        ...
                        function et() {
                            ...
                            if (
                                ...
                                (e = void 0),
                                e6.delete(v),
                                !e6.size && (d(!1), document.documentElement.classList.remove(e8), x('placeFocusBack')))
                            )
                                try {
                        ...
                        let en = {
                            ...
                            init: function (t = [], n = {}) {
                                return (
                                    !(function (t = [], n = {}) {
                                        (g !== e4.Init && (en.destroy(), (g = e4.Init)),
                                            (p = f({}, e3, n)),
                                            (v = x('id') || `fancybox-${++e7}`));
                                        let l = e6.get(v);
                                        if (
                                            ...
                                            (function () {
                                                ...
                                                let n = x('mainStyle');
                                                if (n && a(n))
                                                    for (let [e, t] of Object.entries(n)) i.style.setProperty(e, t);
                                                let l = x('theme'),
                                                    r =
                                                        'auto' === l
                ...
                unbind: function (e, t) {
                    let n = document.body,
                        o = '';
                    if ((l(e) ? (o = e) : e instanceof Element && ((n = e), l(t) && (o = t)), n)) {
